...
public class HologramManager {
    ...
    public void update() {
        ...
        textLines.add("                 \u00a7eBATALHAS   KILLS   MORTES    K/D");
        if (top.isEmpty()) {
            ...
            for (UUID uuid : top) {
                ...
                textLines.add(String.format("#%-2d %s%-16s %5d    %5d    %5d    %4.1f", i, color, name, battles, kills, deaths, kd));
                ++i;
            }
        }
